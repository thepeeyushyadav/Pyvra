...
export const columns: ColumnDef<NonNullable<UsersWithAgencySubAccountPermissionsSidebarOptions>>[] =
  [
    {
      accessorKey: "id",
      header: "",
...
interface CellActionsProps {
  rowData: NonNullable<UsersWithAgencySubAccountPermissionsSidebarOptions>;
}
