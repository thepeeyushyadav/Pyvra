...
import { getConnectAccountProducts } from "@/lib/razorpay/razorpay-actions";
...
const FunnelSettings: React.FC<FunnelSettingsProps> = async ({ subaccountId, defaultData }) => {
    //CHALLENGE: go connect your Razorpay account to sell products
    ...
    return (
        <div className="flex gap-4 flex-col xl:!flex-row">
            <Card className="flex-1 flex-shrink">
                ...
                <CardContent>
                    <>{subaccountDetails.connectAccountId ? <FunnelProductsTable defaultData={defaultData} products={products} /> : "Connect your Razorpay account to sell products."}</>
                </CardContent>
            </Card>
