...
const addAnElement = (
  ...
  if (action.type !== "ADD_ELEMENT")
    throw Error(
      "You sent the wrong action type on the ADD_ELEMENT editor State",
    );
...
const updateAnElement = (
  ...
  if (action.type !== "UPDATE_ELEMENT")
    throw Error(
      "You sent the wrong action type on the UPDATE_ELEMENT editor State",
    );
...
const deleteAnElement = (
  ...
  if (action.type !== "DELETE_ELEMENT")
    throw Error(
      "You sent the wrong action type on the DELETE_ELEMENT editor State",
    );
...
const handleClickedElement = (
  ...
  if (action.type !== "CHANGE_CLICKED_ELEMENT")
    throw Error(
      "You sent the wrong action type on the CHANGE_CLICKED_ELEMENT editor State",
    );
  return {
    ...state,
    editor: {
...
const handleChangeDevice = (state: EditorState, action: EditorAction) => {
  if (action.type !== "CHANGE_DEVICE")
    throw Error(
      "You sent the wrong action type on the CHANGE_DEVICE editor State",
    );
...
const handleTogglePreviewMode = (
  ...
  if (action.type !== "TOGGLE_PREVIEW_MODE")
    throw Error(
      "You sent the wrong action type on the TOGGLE_PREVIEW_MODE editor State",
    );
...
const handleToggleLiveMode = (
  ...
  if (action.type !== "TOGGLE_LIVE_MODE")
    throw Error(
      "You sent the wrong action type on the TOGGLE_LIVE_MODE editor State",
    );
...
const handleRedoState = (
  ...
  if (action.type !== "REDO")
    throw Error("You sent the wrong action type on the REDO editor State");
...
const handleUndoState = (
  ...
  if (action.type !== "UNDO")
    throw Error("You sent the wrong action type on the UNDO editor State");
...
const handleSetFunnelPageIdState = (
  state: EditorState,
  action: EditorAction,
): EditorState => {
  if (action.type !== "SET_FUNNEL_PAGE_ID")
    throw Error(
      "You sent the wrong action type on the SET_FUNNEL_PAGE_ID editor State",
    );
...
const handleLoadData = (
  ...
  initialEditorState: EditorState["editor"],
  action: EditorAction,
): EditorState => {
  if (action.type !== "LOAD_DATA")
    throw Error("You sent the wrong action type on the LOAD_DATA editor State");
...
const editorReducer = (
  ...
  switch (action.type) {
    ...
    case "UNDO":
      ...
      return undoState;
    case "LOAD_DATA":
      const loadedDataState = handleLoadData(
        initialState,
        initialEditorState,
        action,
      );
