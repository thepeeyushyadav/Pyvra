...
const AgencyDetails = ({ data }: Props) => {
  ...
  const handleSubmit = async (values: z.infer<typeof FormSchema>) => {
    try {
      ...
      if (!data?.id) {
        ...
        if (!customerResponse.ok) {
          ...
          toast({
            variant: "destructive",
            title: "Oops!",
            description: "Failed to set up customer profile. Please try again.",
          });
          return;
        }
      ...
      toast({ title: "Saved Agency Information" });
      ...
      toast({
        variant: "destructive",
        title: "Opps!",
        description: `Could not create agency. Error: ${e?.message || e}`,
      });
    }
  };
