...
const InfoBar = ({ notifications, role, className, subAccountId }: Props) => {
  ...
  return (
    <>
      <div
        className={twMerge(
          "fixed z-[20] md:left-[300px] left-0 right-0 top-0 p-4 bg-background/80 backdrop-blur-md flex gap-4 items-center border border-b-[1px]",
          className,
        )}
      >
                  ...
                  <div className="flex gap-2">
                    <Avatar>
                      ...
                      <AvatarFallback className="bg-primary">
                        {notification.User.name.slice(0, 2).toLowerCase()}
                      </AvatarFallback>
                    </Avatar>
                    <div className="flex flex-col">
                      ...
                      <small className="text-sx text-muted-foreground">
